...
![Forward kinematics rendering of the mr2 example robot](../assets/images/diagrams/fk_mr2_example.png)

If implemented properly, the "robots/robot\_urdf\_example.js" example should produce the following rendering:

![Forward kinematics rendering of the URDF example robot description](../assets/images/diagrams/fk_urdf_example.png)

The "robots/robot\_crawler.js" example should produce the following (shown with joint axes highlighted):

![Forward kinematics rendering of the crawler robot with joint axes highlighted](../assets/images/diagrams/fk_crawler_example.png)
...
![Forward kinematics rendering of the RexArm robot description](../assets/images/diagrams/fk_rexarm_example.png)
...
![Forward kinematics rendering of the Fetch mobile manipulator with joint axes highlighted](../assets/images/diagrams/fk_fetch_example.png)

The "robots/sawyer/sawyer.urdf.js" example should produce the following:

![Forward kinematics rendering of the Rethink Robotics Sawyer arm](../assets/images/diagrams/fk_sawyer_example.png)
